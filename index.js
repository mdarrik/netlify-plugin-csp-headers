...
return (
`${url}
    Content-Security-Policy: default-src 'self'; script-src 'self' 'strict-dynamic' 'unsafe-inline' ${hashes['script'].join(" ")}; style-src 'self' 'strict-dynamic' 'unsafe-inline' ${hashes['style'].join(' ')};
`)
}